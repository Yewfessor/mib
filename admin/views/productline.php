        ...
        <table border="0" cellpadding="3" cellspacing="1" bgcolor="#CCCCCC">
            ...
            ?>
                <tr align="center" bgcolor="#FFFFFF">
                    ...
                    <td><a href="models/productlinemodel/productlinedelete.php?delete_id=<?php echo $row["product_line_up_id"]; ?>" onclick="return confirm('ต้องการลบข้อมูลหรือไม่')">ลบ</a></td>
                </tr>
            <?php
            }
            mysqli_close($connection);
