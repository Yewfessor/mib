<div>
    <form action="models/productmodel/productuploadimage.php" method="post" enctype="multipart/form-data" name="upload_hero">
...
<div>
    <form name="show_hero" method="post" action="models/productmodel/productdeleteimage.php">
