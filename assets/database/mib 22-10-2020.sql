...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 22, 2020 at 10:03 PM
...
CREATE TABLE `tb_product` (
  ...
  `product_brand` varchar(50) COLLATE utf8_unicode_ci NOT NULL,
...
--
ALTER TABLE `tb_hero`
  MODIFY `hero_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=22;
